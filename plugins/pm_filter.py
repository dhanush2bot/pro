...
async def give_filter(client, message):
    ...
    reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📷 ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ 🎥 ", url=f"https://t.me/+o_VcAI8GRQ8zYzA9")]])
)
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @LazyDeveloperr
        ...
        [InlineKeyboardButton('𝐂𝐋𝐈𝐂𝐊 𝐓𝐎 𝐏𝐀𝐘 💳', url='https://cosmofeed.com/vig/657538fb2e3f6b001e3cc0c0')],
    ...
    elif query.data == "dhanush":
        buttons = [[
            InlineKeyboardButton('CHECK PLANS', callback_data='paid'), 
        ],[
